        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleAccessLevel = table.Column<byte>(type: "tinyint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applicant_Resume_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "CreatedAt", "RoleAccessLevel", "RoleDescription", "RoleName", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, null, (byte)5, "Là admin cuyền lực.", "Admin", null },
                    { 2, null, (byte)1, "Là nole tư bản đi tìm kiếm miếng cơm manh áo.", "TimViec", null },
                    { 3, null, (byte)1, "Là tư bản đi kiếm những con chiêng ngoan đạo.", "PhatViec", null }
                });
